...
Bound Heuristic::heuristic(const Node& n) const {
 ...
 */
bool NodeOrder::operator()(const Node& n1, const Node& n2) const {
 ...
 * state in the game.
 */
bool NodeComp::operator()(const Node& n1, const Node& n2) const {
 ...
 */
BoundAndMove
GriffinBot::alphaBetaWithMemory(const Node& node, int depth, int alpha, int beta) {
  Bound best_bound;
  Move best_move;
  NodeInfo entry;
